...
| [docs/lifecycles.md](docs/lifecycles.md) | A secret and a share as state machines, from creation to destruction |
| [docs/privacy.md](docs/privacy.md) | What the project itself may observe: logging, metrics, crash reports, libraries |
| [docs/interaction.md](docs/interaction.md) | What each screen is for, and which of its behaviours are decisions |
