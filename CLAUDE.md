...
1. **iOS**: Implement the four backend protocol message types (deposit, list, retrieve, delete) using Swift Crypto / CryptoKit for X25519 + HKDF + ChaCha20-Poly1305 and Ed25519 signing.
